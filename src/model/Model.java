...
public class Model {
	...
	public Model(){
		...
		films.add(new Movie(films.size()+1, "tt0068646", "The Godfather", "18-1-1973",175,"Francis Ford Coppola","The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son."));
		films.add(new Movie(films.size()+1, "tt0468569","The Dark Knight", "24-7-2008", 152,"Christopher Nolan","When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, the caped crusader must come to terms with one of the greatest psychological tests of his ability to fight injustice."));
